...
import { k as AstroError, y as UnknownContentCollectionError, c as createComponent, z as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, B as renderUniqueStylesheet, C as renderScriptElement, D as createHeadAndContent, r as renderComponent } from './astro/server_CcxDCTKC.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DNIWNGE5.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BfNN84No.mjs').then(n => n._);

...
const $$Knowledge = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "ColumnPage", $$ColumnPage, { "id": "knowledge" })}`;
}, "/home/fwb/EN--\u7684\u79D8\u5BC6\u5B9E\u9A8C\u5BA4/src/pages/knowledge.astro", void 0);

const $$file = "/home/fwb/EN--的秘密实验室/src/pages/knowledge.astro";
const $$url = "/knowledge";
